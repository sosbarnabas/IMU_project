...
Ez az eredeti README a [redis++ repójából](https://github.com/sewenew/redis-plus-plus).

```
sudo apt install libhiredis-dev
... redis++ telepítése, mint lentebb ...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/lib
g++ -std=c++17 -o redistest redistest.cpp -lredis++ -lhiredis -pthread
```
